...
const ORBIT_SOURCES: OrbitSource[] = [
  { id: "github", radius: 0.35, size: 40, duration: 16, startAngle: 0 },
  { id: "spotify", radius: 0.35, size: 34, duration: 12, startAngle: 60 },
  { id: "chatgpt", radius: 0.35, size: 30, duration: 11, startAngle: 120, counter: true },
  { id: "youtube", radius: 0.35, size: 32, duration: 14, startAngle: 180 },
  { id: "instagram", radius: 0.35, size: 32, duration: 20, startAngle: 240, counter: true },
  { id: "steam", radius: 0.35, size: 32, duration: 17, startAngle: 300 },
];
