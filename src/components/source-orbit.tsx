...
const ORBIT_SOURCES: OrbitSource[] = [
  { id: "github", radius: 0.35, size: 32, duration: 16, startAngle: 0 },
  { id: "spotify", radius: 0.35, size: 32, duration: 16, startAngle: 60 },
  { id: "instagram", radius: 0.35, size: 32, duration: 16, startAngle: 120 },
  { id: "youtube", radius: 0.35, size: 32, duration: 16, startAngle: 180 },
  { id: "chatgpt", radius: 0.35, size: 32, duration: 16, startAngle: 240 },
  { id: "steam", radius: 0.35, size: 32, duration: 16, startAngle: 300 },
];
